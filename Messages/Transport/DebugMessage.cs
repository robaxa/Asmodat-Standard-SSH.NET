...
// Type: Renci.SshNet.Messages.Transport.DebugMessage
...
{
  [Renci.SshNet.Messages.Message("SSH_MSG_DEBUG", 4)]
  public class DebugMessage : Renci.SshNet.Messages.Message
  {
    ...
    protected override int BufferCapacity => base.BufferCapacity + 1 + 4 + this._message.Length + 4 + this._language.Length;
    ...
    internal override void Process(Session session) => session.OnDebugReceived(this);
  }
}
